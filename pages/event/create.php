...
<nav class="navbar navbar-expand-md navbar navbar-light"  style="background-color: #bec922">
        <div class="container">
          <a class="navbar-brand" href="#.php">Tambah Event</a>
          ...
          <div class="card-body">
            <form class="" action="add.php" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Masukkan nama event" value="">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="decs" placeholder="Masukkan deskripsi event" value="">
              </div>
              <div class="form-group">
